...
<body>
    <form id="form1" runat="server">
        <div style="border-style: solid; border-color: inherit; border-width: medium; z-index: 1; left: 10px; top: 15px; position: absolute; height: 568px; width: 700px;">
            ...
            <asp:GridView ID="gridTareas" runat="server" AutoGenerateColumns="False" Style="z-index: 1; left: 305px; top: 191px; position: absolute; height: 103px; width: 180px" OnSelectedIndexChanging="gridTareas_SelectedIndexChanged">
                <Columns>
