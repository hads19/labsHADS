...
<body style="height: 190px; width: 575px;">
    <form id="form1" runat="server">
        ...
        <div style="background-color:lightskyblue; border-style: solid; border-color: inherit; border-width: medium; width:347px; z-index: 1; left: 227px; top: 15px; position: absolute; height: 185px;">
            ...
            <asp:Label ID="Label2" runat="server" CssClass="auto-style1" style="z-index: 1; left: 113px; top: 98px; position: absolute" Text="Profesores"></asp:Label>
            <ajaxToolkit:DragPanelExtender ID="Label2_DragPanelExtender" runat="server" BehaviorID="Label2_DragPanelExtender" DragHandleID="Label2" TargetControlID="Label2" />
        </div>
