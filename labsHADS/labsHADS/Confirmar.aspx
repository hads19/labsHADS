...
<body>
    <form id="form1" runat="server">
        <div>
            <p style="top: 50px; left: 50px; position: absolute; height: 19px; width: 1526px">El registro se ha realizado correctamente, ya puedes iniciar sesion con tu cuenta.</p>
