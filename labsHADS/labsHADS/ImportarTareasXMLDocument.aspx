...
<body>
    <form id="form1" runat="server">
        <div style="z-index: 1; left: 0px; top: 0px; position: absolute; height: 462px; width: 756px; border:solid; ">
            ...
            <asp:Label ID="Label4" runat="server" style="z-index: 1; left: 336px; top: 130px; position: absolute; width: 300px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: small;" Text="Lista de tareas de la asignatura seleccionada"></asp:Label>
            ...
            <asp:Panel ID="Panel1" runat="server" style="z-index: 1; left: 331px; top: 198px; position: absolute; height: 151px; width: 354px">
